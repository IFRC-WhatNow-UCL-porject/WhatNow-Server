...
class ContentValidator {
    ...
    async contentTypeGetValidator(req, res, next) {
    ...
    async contentGetByIdValidator(req, res, next) {
    ...
    async contentInitValidator(req, res, next) {
    ...
    async contentGetIdsValidator(req, res, next) {
    ...
    async iSContentInitValidator(req, res, next) {
    ...
    async regionContentGetValidator(req, res, next) {
